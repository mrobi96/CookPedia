...
public class menuCemilan extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = (new DB_Resep_cemilan(this)).getWritableDatabase();
    ...
    public void detail(int position) {
        ...
        Intent iIntent = new Intent(this, DB_Parse_cemilan.class);
